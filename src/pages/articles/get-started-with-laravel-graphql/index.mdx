...
export const meta = {
  ...
  date: '2022-01-15',
  title: 'Get Started with GraphQL and Laravel',
  description: 'In this tutorial, we will be using GraphQL with Laravel to create a simple CRUD application that allows us to create, read, update and delete data.',
}
...
Since we already started the app using Sail, we can go to the url: [http://localhost/graphiql](http://localhost/graphiql) to test our endpoints
...
[Repo](https://github.com/icodestuff-io/graphql-basics)
